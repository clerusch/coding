...
\begin{figure}[h!]
    ...
    \subfigure[Detailed view for precise threshold determination of surface code]{\includegraphics[width=0.4\textwidth]{img/figures/thresholds/surfaceThresholdVeryPrecise.png}}
    ...
    \subfigure[Detailed view for precise threshold determination of toric code]{\includegraphics[width=0.4\textwidth]{img/figures/thresholds/toricThresholdVeryPrecise.png}}
    \subfigure[Cylinder code MWPM thresholding overview]{\includegraphics[width=0.4\textwidth]{img/figures/thresholds/cylinderThresholdOverview.png}}\hfill
    \subfigure[Detailed view for precise threshold determination of cylinder code]{\includegraphics[width=0.4\textwidth]{img/figures/thresholds/cylinderThresholdVeryPrecise.png}}
...
\begin{figure}[h!]
    ...
    \subfigure[Lookup table Steane code threshold]{\includegraphics[width=0.4\textwidth]{./img/figures/thresholds/steaneLookupThreshold.png}}\hfill
	\subfigure[Detailed view at around $per=10^{-5}$]{\includegraphics[width=0.4\textwidth]{./img/figures/thresholds/steaneLookupThresholdPrecise.png}}\hfill
